...
2019 because it has the highest median and maximum.


> What about the lowest yielding?  

2020 because it has the lowest median and maximum
...
We used the same boundary and grid size for the three years. They represent a fixed number of cells obtained from creating the grid which was used for interpolation.
...
ggsave("../ouput/spatialstability.png",
       width = 7, height = 3.5)
...
ggsave("../ouput/sy-temp-stability.png",
       width = 6, height = 4)
