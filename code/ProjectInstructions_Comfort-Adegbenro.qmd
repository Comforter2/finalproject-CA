...
These are the cleaned, interpolated yield maps for the field across four crop years. 2016 corn yield ranged between 150 to 200 bu/ac for most part of the field, with some parts showing yield of above 200 bu/ac. Very few points had yields below 150 bu/ac, or above 250 bu/ac. 2017 soybeans showed a high-yielding central band (~35 bu/ac or higher) with lower yields at the edges. 2023 cotton showed a similar high-yield across most of the field (~3,500–5,000 lb/ac). 2024 cotton showed the strongest east-vs-west pattern, with the eastern strip yielding noticeably lower (< 3,000 lb/ac) than the rest of the field. The eastern edge consistently appears as the lowest-yielding zone across years (except for corn), though the magnitude varies for other crops and years.
