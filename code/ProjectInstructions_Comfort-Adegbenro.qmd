...
For soil pH the entire field is Above Optimal (> 6.5) based on the UGA recommendations  for corn (chrome-extension://efaidnbmnnnibpcajpcglclefindmkaj/https://grains.caes.uga.edu/content/dam/caes-subsite/grains/docs/corn/2023-Corn-Production-Guide.pdf). So it is suggested that no lime needed. Additionally, phosphorus level for the field is Mostly Very High (> 100 lb/ac) with some High patches. Hence, phosphorus fertilizer can be skipped or minimized. Lastly, potassium is also Mostly High (151–250 lb/ac) with small Medium spots, and a tiny bit of Very high (>250). A variable-rate K application targeting the Medium zones would be cost-effective. Sufficiency levels for P and K were obtained from this UGA document: (https://aesl.ces.uga.edu/publications/soil/cropsheets.pdf).
